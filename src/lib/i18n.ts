...
export const i18nTexts: Record<Language, I18nTexts> = {
  zh: {
    siteName: 'PhWalls',
    heroTitle: 'Apple Wallpapers',
    heroDescription: '获取苹果设备最新内置壁纸合集，涵盖 iPhone、iPad 和 iMac 系统默认壁纸，支持高清无水印下载。',
    loading: '加载中...',
    exploreButton: '开始探索',
    learnMore: '了解更多',
    about: '关于',
    ...
    copyright: '',
    trademarkDisclaimer: 'Apple、iPhone、iPad、Mac、iOS、macOS 为 Apple Inc. 的商标。本网站为独立项目，与 Apple Inc. 无关联或认可。',
    noWallpapers: '暂无壁纸',
    noWallpapersDescription: '我们正在努力添加更多精美的壁纸，请稍后再来查看。',
    faqQuestion2: '下载的壁纸有水印吗？',
    faqAnswer2: '没有，提供的都是高清无水印原图。',
    faqQuestion3: '壁纸会定期更新吗？',
    faqAnswer3: '会，每次苹果发布新系统，我们都会及时收录最新壁纸。如果您有最新资源，也可以投稿到fenggit@163.com。',
    faqQuestion4: '如何更换iPhone壁纸？',
    faqAnswer4: '请访问Apple官方支持页面了解详细的壁纸更换步骤。',
    faqQuestion5: '如何更换iPad壁纸？',
    faqAnswer5: '请访问Apple官方支持页面了解详细的壁纸更换步骤。',
    faqQuestion6: '如何自定义Mac壁纸？',
    faqAnswer6: '请访问Apple官方支持页面了解详细的壁纸自定义步骤。',
    faqQuestion7: '如何查询 Apple 设备参数信息？',
    faqAnswer7: 'Apple 苹果产品参数中心',
    ...
    aboutDescription: '了解 Apple Wallpapers 的详细信息，解答您可能遇到的问题',
    missionDescription: '我们致力于为苹果用户提供最新、最高质量的系统内置壁纸。通过精心收集和整理，让每一位用户都能轻松获取到官方原生壁纸，为您的设备增添更多个性化选择。',
    qualityDescription: '所有壁纸均为苹果官方原生壁纸，确保最高质量和最纯正的体验',
    ...
    aboutHeroTagline: 'Apple 原厂壁纸资源档案',
    ...
    aboutSupportDesc: '如果你希望了解更换或设置壁纸的方法，可直接访问 Apple 官方文档。',
    ...
    copyrightText1: '本站展示的壁纸版权归原权利人所有。PhWalls 为独立整理站点，与 Apple Inc. 无关联。',
    ...
    customWallpaperDescription: '免费在线设计壁纸制作工具，支持 iPhone、iPad、iMac 壁纸设计。选择预设渐变色或自定义颜色，添加 Apple Logo，一键下载高清壁纸。打造专属你的设备壁纸。',
    customWallpaperKeywords: '设计壁纸,壁纸制作,iPhone壁纸,iPad壁纸,iMac壁纸,在线壁纸设计,Apple壁纸,渐变壁纸,壁纸下载,免费壁纸工具',
    ...
    watchWallpapersGroupTitle: 'Apple Watch 壁纸',
    hdFreeLabel: 'HD 原图',
    backToTopLabel: '返回顶部',
    ...
    // Apple 支持链接
    appleOfficialSupport: 'Apple 官方支持',
  ...
  en: {
    siteName: 'PhWalls',
    heroTitle: 'Apple Wallpapers',
    heroDescription: 'Explore the latest built-in Apple wallpaper collection, featuring iPhone, iPad, and iMac system default wallpapers in HD quality, free to download without watermarks.',
    loading: 'Loading...',
    ...
    trademarkDisclaimer: 'Apple, iPhone, iPad, Mac, iOS, and macOS are trademarks of Apple Inc. This site is not affiliated with or endorsed by Apple.',
    ...
    faqAnswer3: 'Yes, we will promptly collect the latest wallpapers every time Apple releases a new system. If you have the latest resources, you can also submit them to fenggit@163.com.',
    faqQuestion4: 'How to change your iPhone wallpaper?',
    faqAnswer4: 'Please visit Apple\'s support page for detailed wallpaper change instructions.',
    faqQuestion5: 'How to change the wallpaper on iPad?',
    faqAnswer5: 'Please visit Apple\'s support page for detailed wallpaper change instructions.',
    faqQuestion6: 'How to customize the wallpaper on your Mac?',
    faqAnswer6: 'Please visit Apple\'s support page for detailed wallpaper customization instructions.',
    faqQuestion7: 'How to query Apple device parameter information?',
    faqAnswer7: 'Apple Product Parameter Center',
    ...
    aboutDescription: 'Learn more about Apple Wallpapers and get answers to your questions',
    missionDescription: 'We are committed to providing Apple users with the latest and highest quality built-in wallpapers. Through careful collection and organization, we make it easy for every user to access original system wallpapers, adding more personalized choices to your device.',
    ...
    aboutHeroTagline: 'Original Apple Wallpaper Archive',
    ...
    aboutSupportDesc: 'Need help setting wallpapers on your device? Use Apple official support guides.',
    ...
    copyrightText1: 'Wallpaper copyrights belong to their respective owners. PhWalls is an independent archive and is not affiliated with Apple Inc.',
    ...
    customWallpaperDescription: 'Free online custom wallpaper maker for iPhone, iPad, and iMac. Choose preset gradients or custom colors, add Apple Logo, download HD wallpapers instantly. Create unique wallpapers for your devices.',
    customWallpaperKeywords: 'custom wallpaper,wallpaper maker,iPhone wallpaper,iPad wallpaper,iMac wallpaper,online wallpaper design,Apple wallpaper,gradient wallpaper,wallpaper download,free wallpaper tool',
    ...
    watchWallpapersGroupTitle: 'Apple Watch Wallpapers',
    hdFreeLabel: 'HD Free',
    ...
    // Apple 支持链接
    appleOfficialSupport: 'Apple Support',
  ...
  ja: {
    siteName: 'PhWalls',
    heroTitle: 'Apple 壁紙',
    heroDescription: 'Appleデバイスの最新内蔵壁紙コレクションを探索 — iPhone、iPad、iMacのシステム標準壁紙をHD品質で提供。無料で透かしなしのダウンロードが可能。',
    loading: '読み込み中...',
    exploreButton: '探索を開始',
    learnMore: '詳細を見る',
    about: 'について',
    ...
    trademarkDisclaimer: 'Apple、iPhone、iPad、Mac、iOS、macOS は Apple Inc. の商標です。本サイトは Apple Inc. と提携または承認されていません。',
    noWallpapers: '壁紙なし',
    ...
    faqAnswer3: 'はい、Appleが新しいシステムをリリースするたびに、最新の壁紙を迅速に収集します。最新のリソースをお持ちの場合は、fenggit@163.comまで投稿してください。',
    faqQuestion4: 'iPhoneの壁紙を変更する方法は？',
    faqAnswer4: '詳細な壁紙変更手順については、Appleの公式サポートページをご覧ください。',
    faqQuestion5: 'iPadの壁紙を変更する方法は？',
    faqAnswer5: '詳細な壁紙変更手順については、Appleの公式サポートページをご覧ください。',
    faqQuestion6: 'Macの壁紙をカスタマイズする方法は？',
    faqAnswer6: '詳細な壁紙カスタマイズ手順については、Appleの公式サポートページをご覧ください。',
    faqQuestion7: 'Appleデバイスのパラメータ情報を照会する方法は？',
    faqAnswer7: 'Apple製品パラメータセンター',
    ...
    aboutDescription: 'Apple Wallpapersについて詳しく学び、ご質問にお答えします',
    missionDescription: '私たちはAppleユーザーに最新で最高品質の内蔵壁紙を提供することにコミットしています。慎重な収集と整理を通じて、すべてのユーザーが公式ネイティブ壁紙に簡単にアクセスできるようにし、デバイスにより多くの個性化オプションを追加します。',
    qualityDescription: 'すべての壁紙はApple公式ネイティブ壁紙で、最高品質と最も本格的な体験を保証します',
    ...
    aboutHeroTagline: 'Apple 純正壁紙アーカイブ',
    ...
    aboutSupportTitle: 'Apple 公式サポート',
    aboutSupportDesc: '壁紙の設定方法は Apple 公式ガイドをご確認ください。',
    ...
    copyrightText1: '掲載されている壁紙の著作権は各権利者に帰属します。PhWalls は独立したアーカイブで、Apple Inc. とは提携していません。',
    ...
    customWallpaperDescription: 'iPhone、iPad、iMac用の無料オンラインカスタム壁紙メーカー。プリセットグラデーションまたはカスタムカラーを選択し、Appleロゴを追加、HD壁紙を即座にダウンロード。デバイス専用のユニークな壁紙を作成。',
    customWallpaperKeywords: 'カスタム壁紙,壁紙メーカー,iPhone壁紙,iPad壁紙,iMac壁紙,オンライン壁紙デザイン,Apple壁紙,グラデーション壁紙,壁紙ダウンロード,無料壁紙ツール',
    ...
    watchWallpapersGroupTitle: 'Apple Watch 壁紙',
    hdFreeLabel: 'HD 原画',
    ...
    // Apple 支持链接
    appleOfficialSupport: 'Apple 公式サポート',
  ...
  vi: {
    siteName: 'PhWalls',
    heroTitle: 'Hình nền Apple',
    heroDescription: 'Khám phá bộ sưu tập hình nền tích hợp mới nhất của Apple — bao gồm hình nền mặc định hệ thống cho iPhone, iPad và iMac với chất lượng HD, miễn phí và không có watermark.',
    loading: 'Đang tải...',
    ...
    footerDescription: 'Thư viện hình nền hệ điều hành gốc cho iPhone, iPad và Mac qua mọi thế hệ. Tải xuống hình nền tích hợp 4K/5K/6K siêu nét, bao phủ đầy đủ iOS, iPadOS và macOS, giúp thiết bị tái hiện chuẩn thẩm mỹ nguyên bản của Apple.',
    copyright: '© 2025 PhWalls. Bảo lưu mọi quyền.',
    trademarkDisclaimer: 'Apple, iPhone, iPad, Mac, iOS và macOS là các nhãn hiệu của Apple Inc. Trang web này độc lập và không liên kết hay được Apple chứng thực.',
    ...
    faqAnswer3: 'Có, chúng tôi sẽ nhanh chóng thu thập hình nền mới nhất mỗi khi Apple phát hành hệ thống mới. Nếu bạn có tài nguyên mới nhất, bạn cũng có thể gửi chúng đến fenggit@163.com.',
    faqQuestion4: 'Làm thế nào để thay đổi hình nền iPhone?',
    faqAnswer4: 'Vui lòng truy cập trang hỗ trợ chính thức của Apple để biết hướng dẫn chi tiết về cách thay đổi hình nền.',
    faqQuestion5: 'Làm thế nào để thay đổi hình nền trên iPad?',
    faqAnswer5: 'Vui lòng truy cập trang hỗ trợ chính thức của Apple để biết hướng dẫn chi tiết về cách thay đổi hình nền.',
    faqQuestion6: 'Làm thế nào để tùy chỉnh hình nền trên Mac?',
    faqAnswer6: 'Vui lòng truy cập trang hỗ trợ chính thức của Apple để biết hướng dẫn chi tiết về cách tùy chỉnh hình nền.',
    faqQuestion7: 'Làm thế nào để tra cứu thông tin tham số thiết bị Apple?',
    faqAnswer7: 'Trung tâm tham số sản phẩm Apple',
    login: 'Đăng nhập',
    logout: 'Đăng xuất',
    ...
    aboutDescription: 'Tìm hiểu thêm về Apple Wallpapers và nhận câu trả lời cho câu hỏi của bạn',
    missionDescription: 'Chúng tôi cam kết cung cấp cho người dùng Apple những hình nền tích hợp sẵn mới nhất và chất lượng cao nhất. Thông qua việc thu thập và tổ chức cẩn thận, chúng tôi giúp mọi người dùng dễ dàng truy cập hình nền gốc chính thức, thêm nhiều lựa chọn cá nhân hóa cho thiết bị của bạn.',
    qualityDescription: 'Tất cả hình nền đều là hình nền gốc chính thức của Apple, đảm bảo chất lượng cao nhất và trải nghiệm chân thực nhất',
    ...
    aboutHeroTagline: 'Kho Hinh Nen Goc Apple',
    ...
    aboutSupportDesc: 'Bạn có thể xem hướng dẫn từ Apple để cài đặt hình nền trên thiết bị.',
    ...
    copyrightText1: 'Bản quyền hình nền thuộc về các chủ sở hữu tương ứng. PhWalls là kho lưu trữ độc lập và không liên kết với Apple Inc.',
    ...
    customWallpaperDescription: 'Công cụ tạo hình nền tùy chỉnh miễn phí trực tuyến cho iPhone, iPad và iMac. Chọn gradient có sẵn hoặc màu tùy chỉnh, thêm logo Apple, tải xuống hình nền HD ngay lập tức. Tạo hình nền độc đáo cho thiết bị của bạn.',
    customWallpaperKeywords: 'hình nền tùy chỉnh,công cụ tạo hình nền,hình nền iPhone,hình nền iPad,hình nền iMac,thiết kế hình nền trực tuyến,hình nền Apple,hình nền gradient,tải xuống hình nền,công cụ miễn phí',
    ...
    watchWallpapersGroupTitle: 'Hình nền Apple Watch',
    hdFreeLabel: 'HD gốc',
    ...
    // Apple 支持链接
    appleOfficialSupport: 'Hỗ trợ chính thức của Apple',
  ...
  'zh-hant': {
    siteName: 'PhWalls',
    heroTitle: 'Apple Wallpapers',
    heroDescription: '獲取蘋果設備最新內建壁紙合集，涵蓋 iPhone、iPad 和 iMac 系統預設壁紙，支援高清無浮水印下載。',
    loading: '載入中...',
    exploreButton: '開始探索',
    learnMore: '了解更多',
    about: '關於',
    ...
    trademarkDisclaimer: 'Apple、iPhone、iPad、Mac、iOS、macOS 為 Apple Inc. 的商標。本網站為獨立專案，與 Apple Inc. 無關聯或認可。',
    noWallpapers: '暫無壁紙',
    noWallpapersDescription: '我們正在努力新增更多精美的壁紙，請稍後再來檢視。',
    faqQuestion2: '下載的壁紙有浮水印嗎？',
    faqAnswer2: '沒有，提供的都是高清無浮水印原圖。',
    faqQuestion3: '壁紙會定期更新嗎？',
    faqAnswer3: '會，每次蘋果發布新系統，我們都會及時收錄最新壁紙。如果您有最新資源，也可以投稿到fenggit@163.com。',
    faqQuestion4: '如何更換iPhone壁紙？',
    faqAnswer4: '請存取Apple官方支援頁面了解詳細的壁紙更換步驟。',
    faqQuestion5: '如何更換iPad壁紙？',
    faqAnswer5: '請存取Apple官方支援頁面了解詳細的壁紙更換步驟。',
    faqQuestion6: '如何自訂Mac壁紙？',
    faqAnswer6: '請存取Apple官方支援頁面了解詳細的壁紙自訂步驟。',
    faqQuestion7: '如何查詢 Apple 設備參數資訊？',
    faqAnswer7: 'Apple 蘋果產品參數中心',
    ...
    aboutDescription: '了解 Apple Wallpapers 的詳細資訊，解答您可能遇到的問題',
    missionDescription: '我們致力於為蘋果使用者提供最新、最高品質的系統內建壁紙。通過精心收集和整理，讓每一位使用者都能輕鬆獲取到官方原生壁紙，為您的設備增添更多個人化選擇。',
    qualityDescription: '所有壁紙均為蘋果官方原生壁紙，確保最高品質和最純正的體驗',
    ...
    aboutHeroTagline: 'Apple 原廠桌布資源檔案',
    ...
    aboutSupportDesc: '如需更換桌布教學，可直接前往 Apple 官方支援文件。',
    ...
    copyrightText1: '本站展示的壁紙版權歸原權利人所有。PhWalls 為獨立整理站點，與 Apple Inc. 無關聯。',
    ...
    customWallpaperDescription: '免費線上設計壁紙製作工具，支援 iPhone、iPad、iMac 壁紙設計。選擇預設漸變色或自訂顏色，新增 Apple Logo，一鍵下載高清壁紙。打造專屬你的設備壁紙。',
    customWallpaperKeywords: '設計壁紙,壁紙製作,iPhone壁紙,iPad壁紙,iMac壁紙,線上壁紙設計,Apple壁紙,漸變壁紙,壁紙下載,免費壁紙工具',
    ...
    ipadLandscapeWallpapersGroupTitle: 'iPad 壁紙',
    desktopWallpapersGroupTitle: 'Mac 壁紙',
    watchWallpapersGroupTitle: 'Apple Watch 桌布',
    hdFreeLabel: 'HD 原圖',
    backToTopLabel: '返回頂部',
    ...
    // Apple 支持链接
    appleOfficialSupport: 'Apple 官方支援',
