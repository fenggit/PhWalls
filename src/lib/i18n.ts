...
export interface I18nTexts {
  ...
  notFoundBrandLinksTitle: string;
  notFoundBrandLinksDescription: string;
...
export const i18nTexts: Record<Language, I18nTexts> = {
  zh: {
    ...
    faqQuestion2: '哪里可以下载高清无水印 iPhone 壁纸？',
    faqAnswer2: '在 PhWalls 的 iPhone 壁纸分类中，可按机型与代际下载高清无水印原图，常见分辨率覆盖 4K/5K/6K。',
    faqQuestion3: '如何按 iOS 版本查找官方系统壁纸？',
    faqAnswer3: '进入 iOS 壁纸分类后，可按系统版本浏览，如 iOS 17、iOS 18 等，并查看对应版本的官方内置壁纸。',
    faqQuestion4: 'iPad 壁纸和 iPadOS 壁纸有什么区别？',
    faqAnswer4: 'iPad 壁纸更偏向按设备系列整理，iPadOS 壁纸更偏向按系统版本整理。按设备找图选 iPad，按系统找图选 iPadOS。',
    faqQuestion5: 'Mac 和 macOS 壁纸支持哪些清晰度下载？',
    faqAnswer5: 'PhWalls 提供适配桌面场景的 Mac/macOS 高清原图下载，常见分辨率包括 4K、5K、6K，可直接用于 MacBook 与 iMac。',
    faqQuestion6: '新机型或新系统壁纸多久更新一次？',
    faqAnswer6: '当新 iPhone、iPad、iOS、iPadOS 或 macOS 版本发布后，我们会尽快补充对应官方壁纸并更新页面索引。',
    faqQuestion7: '如何快速找到指定机型的官方壁纸？',
    faqAnswer7: '从首页进入对应品牌与设备分类页，再按机型与版本浏览即可快速定位目标壁纸合集。',
    ...
    notFoundHeroDescription: '这个链接可能已经失效、被重命名或被移除。你可以从下面的主要品牌分类继续浏览壁纸，避免停在无效页面。',
    ...
    notFoundBrandLinksTitle: '从有效分类页继续浏览',
    notFoundBrandLinksDescription: '这些入口可以帮助用户和搜索引擎快速回到已验证的壁纸集合页面。',
    notFoundFooterNote: 'PhWalls 整理各品牌壁纸落地页。当旧链接失效时，建议从上面的分类入口继续浏览，而不是把所有 404 都重定向到首页。',
    ...
    aboutDesktopDesc: '涵盖 Windows、Ubuntu、ChromeOS、Surface、Google OS 等主流桌面系统官方内置壁纸，高清原图免费下载。',
    ...
    copyrightText2: '如涉及版权问题，请联系 fenggit@gmail.com，我们将及时处理。',
    homeButton: '首页',
    ...
    wallpapers: '张壁纸',
    allWallpapers: '全部壁纸',
    phoneWallpapersGroupTitle: '手机壁纸',
    ...
    brandCategorySeoTitleTemplate: '{brand}手机壁纸',
  ...
  en: {
    ...
    faqAnswer3: 'Yes, we will promptly collect the latest wallpapers every time Phone releases a new system. If you have the latest resources, you can also submit them to fenggit@gmail.com.',
    ...
    notFoundHeroDescription: 'The link may be outdated, renamed, or removed. Browse the main brand categories below to keep exploring wallpapers without hitting a dead end.',
    ...
    notFoundBrandLinksTitle: 'Continue from a verified collection page',
    notFoundBrandLinksDescription: 'These landing pages are the best recovery points for both users and search engines when an old URL is no longer valid.',
    notFoundFooterNote: 'PhWalls organizes wallpaper landing pages across major brands. If an external or bookmarked URL breaks, use the verified category pages above instead of redirecting every missing page to the homepage.',
    ...
    aboutDesktopDesc: 'Official built-in wallpapers for Windows, Ubuntu, ChromeOS, Surface, Google OS and more. HD downloads, free.',
    ...
    copyrightText2: 'If you believe any content infringes your rights, contact fenggit@gmail.com and we will address it promptly.',
    homeButton: 'Home',
    ...
    phoneWallpapersGroupTitle: 'Phone Wallpapers',
    ...
    brandCategorySeoTitleTemplate: '{brand} Wallpapers',
  ...
  ja: {
    ...
    faqAnswer3: 'はい、Phoneが新しいシステムをリリースするたびに、最新の壁紙を迅速に収集します。最新のリソースをお持ちの場合は、fenggit@gmail.comまで投稿してください。',
    ...
    notFoundHeroDescription: 'リンクが古い、名称変更された、または削除された可能性があります。以下の主要ブランドカテゴリから壁紙を引き続き閲覧できます。',
    ...
    notFoundBrandLinksTitle: '有効なコレクションページから再開',
    notFoundBrandLinksDescription: '古い URL が無効な場合でも、ユーザーと検索エンジンを適切な壁紙一覧へ戻すための入口です。',
    notFoundFooterNote: 'PhWalls は主要ブランドの壁紙ランディングページを整理しています。古いリンクが切れている場合は、すべてをホームへ転送するのではなく、上の有効なカテゴリーページをご利用ください。',
    ...
    aboutDesktopDesc: 'Windows、Ubuntu、ChromeOS、Surface、Google OS など主要デスクトップシステムの公式壁紙を高解像度でダウンロード。',
    ...
    copyrightText2: '著作権に関するご連絡は fenggit@gmail.com までお願いします。迅速に対応します。',
    homeButton: 'ホーム',
    ...
    phoneWallpapersGroupTitle: 'スマホ壁紙',
    ...
    brandCategorySeoTitleTemplate: '{brand}スマートフォン壁紙',
  ...
  vi: {
    ...
    faqAnswer3: 'Có, chúng tôi sẽ nhanh chóng thu thập hình nền mới nhất mỗi khi Phone phát hành hệ thống mới. Nếu bạn có tài nguyên mới nhất, bạn cũng có thể gửi chúng đến fenggit@gmail.com.',
    ...
    notFoundHeroDescription: 'Liên kết có thể đã cũ, bị đổi tên hoặc bị xóa. Bạn vẫn có thể tiếp tục khám phá hình nền từ các danh mục thương hiệu chính bên dưới.',
    ...
    notFoundBrandLinksTitle: 'Tiếp tục từ trang bộ sưu tập hợp lệ',
    notFoundBrandLinksDescription: 'Đây là các điểm quay lại tốt nhất cho cả người dùng và công cụ tìm kiếm khi một URL cũ không còn hợp lệ.',
    notFoundFooterNote: 'PhWalls tổng hợp các trang đích hình nền theo các thương hiệu chính. Khi một liên kết cũ bị lỗi, hãy dùng các trang danh mục đã xác thực phía trên thay vì chuyển mọi trang 404 về trang chủ.',
    ...
    aboutDesktopDesc: 'Bao gồm hình nền chính thức cho Windows, Ubuntu, ChromeOS, Surface, Google OS và nhiều hệ thống khác. Tải xuống HD miễn phí.',
    ...
    copyrightText2: 'Nếu có vấn đề bản quyền, vui lòng liên hệ fenggit@gmail.com, chúng tôi sẽ xử lý kịp thời.',
    ...
    phoneWallpapersGroupTitle: 'Hình nền điện thoại',
    ...
    brandCategorySeoTitleTemplate: 'Hình nền điện thoại {brand}',
  ...
  'zh-hant': {
    ...
    faqQuestion2: '哪裡可以下載高清無浮水印 iPhone 壁紙？',
    faqAnswer2: '在 PhWalls 的 iPhone 壁紙分類中，可依機型與世代下載高清無浮水印原圖，常見解析度涵蓋 4K/5K/6K。',
    faqQuestion3: '如何依 iOS 版本查找官方系統壁紙？',
    faqAnswer3: '進入 iOS 壁紙分類後，可依系統版本瀏覽，如 iOS 17、iOS 18 等，並查看對應版本的官方內建壁紙。',
    faqQuestion4: 'iPad 壁紙與 iPadOS 壁紙有什麼差異？',
    faqAnswer4: 'iPad 壁紙偏向按裝置系列整理，iPadOS 壁紙偏向按系統版本整理。按裝置找圖選 iPad，按系統找圖選 iPadOS。',
    faqQuestion5: 'Mac 與 macOS 壁紙支援哪些清晰度下載？',
    faqAnswer5: 'PhWalls 提供適配桌面場景的 Mac/macOS 高清原圖下載，常見解析度包含 4K、5K、6K，可直接用於 MacBook 與 iMac。',
    faqQuestion6: '新機型或新系統壁紙多久更新一次？',
    faqAnswer6: '當新 iPhone、iPad、iOS、iPadOS 或 macOS 版本發佈後，我們會盡快補充對應官方壁紙並更新頁面索引。',
    faqQuestion7: '如何快速找到指定機型的官方壁紙？',
    faqAnswer7: '從首頁進入對應品牌與裝置分類頁，再依機型與版本瀏覽即可快速定位目標壁紙合集。',
    ...
    notFoundHeroDescription: '這個連結可能已失效、被重新命名或被移除。你可以從下方主要品牌分類繼續瀏覽桌布，不必停留在無效頁面。',
    ...
    notFoundBrandLinksTitle: '從有效分類頁繼續瀏覽',
    notFoundBrandLinksDescription: '當舊網址失效時，這些入口可以幫助使用者與搜尋引擎快速回到已驗證的桌布集合頁。',
    notFoundFooterNote: 'PhWalls 整理各品牌桌布落地頁。當舊連結失效時，建議從上方分類入口繼續瀏覽，而不是將所有 404 都重新導向首頁。',
    ...
    aboutDesktopDesc: '涵蓋 Windows、Ubuntu、ChromeOS、Surface、Google OS 等主流桌面系統官方內置桌布，高清原圖免費下載。',
    ...
    copyrightText2: '如涉及版權問題，請聯絡 fenggit@gmail.com，我們將及時處理。',
    homeButton: '首頁',
    ...
    wallpapers: '張壁紙',
    allWallpapers: '全部壁紙',
    phoneWallpapersGroupTitle: '手機壁紙',
    ipadPortraitWallpapersGroupTitle: 'iPad 壁紙',
    ipadLandscapeWallpapersGroupTitle: 'iPad 壁紙',
    desktopWallpapersGroupTitle: 'Mac 壁紙',
    ...
    brandCategorySeoTitleTemplate: '{brand}手機桌布',
