...
- 修复移动端语言菜单点击选项后无法切换语言的问题
- 恢复移动端 Header 的 Share 快捷入口，并沿用系统分享与链接复制降级逻辑
- 语言菜单改为可抓取的真实链接，保留当前路径与语言偏好
- HONOR 英文品牌页主词调整为“HONOR Wallpapers”，并保留官方 Stock 壁纸的下载语义
- 修复首页反复打开英文的问题，语言自动选择改为用户偏好优先、浏览器语言次之，并移除 IP 地区判断
- 新增 Android 17、Xiaomi 13 与 Xiaomi 13 Pro 壁纸，并拆分原 Xiaomi 13 (Pro) 合集
...
### v1.1.4 - 2026-09-20
- 新增 Omarchy Linux 桌面壁纸
- 修复桌面壁纸分类页的宽屏卡片很小
- 补齐首页 Header 中 Desktop 分类的简中、日文、越南语和繁中本地化名称
- 新增 Sony Xperia 10 VIII 
- 重构全站 Header 导航，将手机、Apple 与桌面壁纸分级展示，并优化移动端分类菜单
- 修复桌面端 Header 下拉菜单被父级宽度压缩，导致品牌名称换行重叠的问题
- 将 Header 手机品牌菜单拆分为热门品牌与更多品牌，并使用稳定的导航顺序提升扫读效率

### v1.1.4 - 2026-09-16
- 新增 Samsung Galaxy S26 FE 的 3 张壁纸，合集日期为 2026 年 8 月 27 日

### v1.1.4 - 2026-09-14
- 修复品牌、手机与桌面壁纸详情及信息页的描述标签落入正文问题，按页面与语言在 HTML 标头中输出说明，便于搜索引擎抓取
- 修复站点地图只列出英文页面的问题，补齐五种语言的独立 URL，覆盖华为 MateBook Fold 中文详情页等页面
- 增加 IndexNow 公开验证文件与批量提交命令，部署后自动提交线上站点地图，支持预览、定向补交与失败提示

### v1.1.4 - 2026-09-09
- 新增 Ubuntu 26.10 与 Huawei Mate XT 2 壁纸合集及发布日期

### v1.1.4 - 2026-09-08
- 优化首页、22 个手机／系统／平板分类与 5 个桌面分类的五语言搜索标题和简介，按地区用语突出实际收录系列与原图免费下载
